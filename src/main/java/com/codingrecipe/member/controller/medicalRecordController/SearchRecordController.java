...
import com.codingrecipe.member.service.appointmentsService.SearchAppointmentsService;
import com.codingrecipe.member.service.medicalRecordService.SearchRecordService;
                                               ...
                                               @RequestParam(required = false) String date)
    {
        ...
        try {
            ...
            if (authentication != null && !(authentication instanceof AnonymousAuthenticationToken) && authentication.isAuthenticated()) {
                ...
                recordDTOS = searchRecordService.searchRecords(userId, hospitalName, localDate);
